...
local function setup_commands()
  ...
  vim.api.nvim_create_user_command("TurboLogCommentAll", function()
    bulk.comment_all()
  end, {})
  vim.api.nvim_create_user_command("TurboLogUncommentAll", function()
    bulk.uncomment_all()
  end, {})
  vim.api.nvim_create_user_command("TurboLogDeleteAll", function()
    bulk.delete_all()
  end, {})
  vim.api.nvim_create_user_command("TurboLogCorrectAll", function()
    bulk.correct_all()
  end, {})
